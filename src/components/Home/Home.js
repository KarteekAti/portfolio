    ...
    return (
        <section id="home" className=" px-12 py-5 mb-10 text-purple-700 flex xs:flex-col md:flex-row ">
            <div className='md:w-2/3'>
                ...
                <p className="dark:text-zinc-200 leading-normal xs:mb-6 md:mb-2 xs:text-center md:text-start m-auto break-normal text-xl text-black font-">I'm a passionate Backend Developer 💻 having experience with Python, Flask, React.js, Node.js and a Machine Learning enthusiast 🤖.</p>
                ...
                <div className='p-2 flex flex-row xs:justify-center md:justify-start xs:items-center md:items-start gap-6'>
                    ...
                    <Link to=''><button className='bg-transparent py-1 px-4 border text-black border-black hover:bg-black font-semibold hover:text-white hover:border-transparent rounded dark:text-white dark:border-white dark:hover:border-black' onClick={(e) => { window.location.href = 'mailto:ati.karteek99@gmail.com'; }}>Contact Me</button></Link>
                </div>
